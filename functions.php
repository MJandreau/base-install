...
function baseinstall_scripts() {
	...
	wp_enqueue_script( 'baseinstall-navigation', get_template_directory_uri() . '/assets/js/vendor/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'baseinstall-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/vendor/skip-link-focus-fix.js', array(), '20151215', true );
