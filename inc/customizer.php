...
function baseinstall_customize_preview_js() {
	wp_enqueue_script( 'baseinstall_customizer', get_template_directory_uri() . '/assets/js/vendor/customizer.js', array( 'customize-preview' ), '20151215', true );
}
